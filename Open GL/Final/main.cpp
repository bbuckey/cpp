...
PARAMETERS,PAWN, TEXTURE, LFTCURLY, RGHTCURLY, DEF, USE, T_NULL, F_EOF, UNKNOWN, SPOTLIGHT, TEXTUREPROJRETION, GLASS};
...
GeomObj * Scene::getObject()
{
	...
	{		
		...
		default:  
			...
			case GLASS:			newShape = new Mesh("glass.3vn"); break;
			case MESH: 
				{		
...
//	glHint(GL_PRESPECTIVE_CORRECTION_HINT,GL_NICEST);
	glFlush();
}
